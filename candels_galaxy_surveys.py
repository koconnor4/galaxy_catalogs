...
pickle.dump(gc,open('gc.pkl','wb'))
'''

#print(gc)
#temp = gc.gal_skycoords(['goodsn','goodss'])
#print(len(temp))
#print(temp[0])


#temp2 = gc.nearby(['cos','goodsn'],SkyCoord(150.056818, 2.173421,unit=(u.deg,u.deg)))

#print(len(temp2))
#print(temp2)
#print(len(temp2.mass))


#print(temp[1])
#print(cos_catalog.cos)
